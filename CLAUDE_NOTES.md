...
```bash
java -jar practitioner-taxonomy-repair-1.6.2-jar-with-dependencies.jar \
...
| `v1.6.2` (Latest) | 2026-07-27 | `fab42c1` | `practitioner_taxonomy_repair_v1.6.2.zip` (jar `1.6.2`) | **Safety + auditability release for `run_repair.ps1`.** (1) **Dry-run is now the DEFAULT** -- `[switch]$DryRun = $true`. A bare `.
