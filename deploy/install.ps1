...
Write-Host "  2. Run the repair orchestrator (DRY-RUN IS THE DEFAULT -- pass -Execute for a real run):"
Write-Host "       cd `"$REPAIR_DIR`""
Write-Host "       .\run_repair.ps1 -NpiFile pilot.txt              # dry-run a pilot list (writes nothing)"
Write-Host "       .\run_repair.ps1 -NpiFile pilot.txt -Execute     # stage the pilot + invoke the loader"
Write-Host "       .\run_repair.ps1 -Execute                        # auto-derive NPI list, real run"
Write-Host "       .\run_repair.ps1 -RunId 7 -Execute               # resume the loader for run 7"
Write-Host ""
